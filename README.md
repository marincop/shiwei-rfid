# 澤銳科技股份有限公司 — RFID 解決方案網站

這是一個專為「澤銳科技股份有限公司」設計的現代化、高質感單頁式網站（Single Page Application）。主要用於展示公司的核心優勢、應用場景、導入流程，並配備一個**互動式 RFID 解決方案設計器（Solution Designer Wizard）**，幫助客戶在線上評估合適的解決方案，並一鍵填寫諮詢表單。
